      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-6">
          ...
          <Tabs value={loginMethod} onValueChange={setLoginMethod} className="w-full">
            ...
            <TabsContent value="phone" className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="phone-password" type="password" placeholder="Enter your password" />
              </div>
              <Button className="w-full btn-wasfah">
                Sign In with Phone
              </Button>
              <div className="text-center">
                <Button variant="link" className="text-sm text-wasfah-bright-teal">
                  Send OTP instead
                </Button>
              </div>
            </TabsContent>
          ...
          <div className="text-center space-y-2">
            <Link to="/forgot-password" className="text-sm text-wasfah-bright-teal hover:underline">
